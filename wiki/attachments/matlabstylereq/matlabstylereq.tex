...
\textmcode{Vec(CVec)} for numeric (cell) vectors
\textmcode{Mat(CMat)} for numeric (cell) matrices, \textmcode{Array(CArray)} for multi-dimentional numeric (cell) arrays: \textmcode{point,pointMat} where \textmcode{point} is singular and
