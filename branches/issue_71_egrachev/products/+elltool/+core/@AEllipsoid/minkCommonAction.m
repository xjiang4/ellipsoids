...
if (nargout == 1)||(nargout == 0)
    ...
    [plObj,nDim,isHold]= plotgeombodyarr(@(x)(isa(x,'ellipsoid') || isa(x, 'elltool.core.GenEllipsoid')),...
    ...
    if (nDim < 3)
        ...
        plObj= plotgeombodyarr(@(x)(isa(x,'ellipsoid') || isa(x, 'elltool.core.GenEllipsoid')),...
