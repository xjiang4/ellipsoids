...
modgen.common.checkvar(secObjArr,@(x) isa(x, 'elltool.core.GenEllipsoid') ||...
    isa(x, 'polytope') || isa(x, 'ellipsoid'),'errorTag','wrongInput', 'errorMessage',...
    'second input argument must be elltool.core.GenEllipsoid or polytope.');
...
if isa(secObjArr,'elltool.core.GenEllipsoid') || isa(secObjArr, 'ellipsoid')
...
if isAnyObjEmpty
    ...
    'Array should not have empty ellipsoid, GenEllipsoid or polytope.');
end
