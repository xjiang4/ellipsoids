...
if nargout == 0
    ...
    if isPlotCenter3d
        ...
        plotgeombodyarr('elltool.core.GenEllipsoid',@fCalcCenterTriArr,...
...
elseif nargout == 1
    ...
    if isPlotCenter3d
        ...
        plObj = plotgeombodyarr('elltool.core.GenEllipsoid',@fCalcCenterTriArr,...
            @(varargin)patch(varargin{:},'marker','*'),reg{:},...
            'relDataPlotter',plObj, 'priorHold',true,'postHold',isHold);
    end
    varargout = {plObj};
    ...
    function ellsVec = getEllArr(ellsArr)
        if isa(ellsArr, 'elltool.core.GenEllipsoid')
            cnt    = numel(ellsArr);
...
%         import calcdiffonedir;
        ...
        if ~isbigger(fstEll, secEll)
            ...
            [diffBoundMat,isPlotCenter3d] = ...
                elltool.core.AEllipsoid.calcdiffonedir(fstEll,secEll,lMat,...
    ...
    function [ellsArr,nDim] = rebuildOneDim2TwoDim(ellsArr)
        ...
        function ellTwoDim = oneDim2TwoDim(ell)
            ...
            ellTwoDim = elltool.core.GenEllipsoid([ellCenVec, 0].', ...
                diag([qMat, 0]));
        end
    end
