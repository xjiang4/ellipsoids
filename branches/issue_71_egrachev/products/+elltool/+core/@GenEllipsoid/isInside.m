...
% ISINSIDE - checks if given generalized ellipsoid(or array of
%            generalized ellipsoids) lies inside given object(or array
...
checkvar(objArr,@(x) isa(x,'polytope') || isa(x,'elltool.core.GenEllipsoid'),...
    ...
    'second argument must be vector of generalized ellipsoids or polytopes.');
...
isEll = isa(objArr,'elltool.core.GenEllipsoid');
if ~isEllScal && ~isPolyScal
