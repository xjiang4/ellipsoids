...
%                              x   = Cx   + D      (13)
%                               Bc     Nc              
%     The above QP/LP problem (1)-(3)  can be expressed only in non-basic variables
%  x_Nc  as follows: 
%                                  1    T      T                    
%                            min   - x   Hx  +f x   + c        (14) 
%                                  2  Nc   Nc    Nc                 
...
%                   b  =  b - A  D                                     (20) 
%                              Bc                                           
%     Original solution to QP problem (1)-(3)  can be obtained via relation (13).
%  Problem (14)-(15)  can be transformed to (4)-(6)  effectively when considering
%  the rank of the matrix A. If the rank of matrix A  is less than the number of
%  inequalities in (15)  vector x_N  can be expressed as a difference of two
...
%                                    ( x     )        
%                                    (  Nc   )        
%     and putting back to (14)-(15)  we get 
%                           1  T (        )    (  T   T  )                 
...
%                           (       )                                      
%                           v >= 0                                    (28) 
%     which is a form equivalent to (4)-(6). If the rank of matrix A  is greater or
%  equal than the number of inequalities in (15), we can factorize the matrix A 
%  rowwise 
%                                        (     )
%                                        ( A   )
%                                        (  B  )
...
%  built. The factored system (15)  can be written as 
%                                          >= -b             
%                                   -A x                (29) 
%                                     B Nc      B            
%                                          >= -b             
...
%                              -A x         + y     (31)
%                                B Nc     B             
%     the system (26)(27)  can be rewritten in variable y 
%                     1  T (  -T   -1 )    (   -T   -1b    -T  )                 
