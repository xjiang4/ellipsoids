...
%                                          n     n            
%                                         x in K         (15) 
%     Since QP is convex, we can express (10)-(12)  in an epigraph form 
%                                                                 
%                              min   t                       (16) 
%                                                                 
%                             s.t.   Ax <= b                 (17) 
...
%                                    2                            
%                                                            (20) 
%     over quadratic constraints (19). From the literature for convex programming
%  follows that the quadratic constraints (19)  can be written as conic constraints
%   {                                        (             ||   Qx     ||  ) }     
%                                           
%   {                                        (   T         ||    T     ||  ) }     
%                                           
...
%  allows us to rewrite the epigraph form of QP (16)-(19)to a primal form (13)-(15)
...
%   the linear equality constraints (14)  can be expressed in z  variable as  A_nz
%  = c_c  where 
%                                ( 0  -A   A  -I 0  0   ) 
%                                (                      ) 
%                                ( 0  A   -A  0  0  0   ) 
...
%                                ( --  )                  
%                                ( 2   )                  
%     The objective function in (13)  is composed as c_n^T = [1,  0,  0,  0,  0, 
%  0]. The individual constraints K  in (15)  are given in z  vector as follows: t 
