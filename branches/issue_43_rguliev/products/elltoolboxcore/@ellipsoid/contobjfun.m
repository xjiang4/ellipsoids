...
%
% CONTOBJFUN - objective function for containment checking of 
%              two ellipsoids (secondEll in firstEll).
%
% Input:
%   regular:
...
%   resGVec: double[nDims, 1] - Subtraction between
...
ellipsoid.checkIsMe(firstEll,'second');
ellipsoid.checkIsMe(secondEll,'third');
